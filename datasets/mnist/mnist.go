...
func LoadMnistTrain() (*mat.Dense, *mat.Dense) {
  ...
  fmt.Println("Successfully read mnist training dataset")

	return XTtrain, yTrain
}

func LoadMnistTest() (*mat.Dense, *mat.Dense) {
	...
	filePath := "dataSets/mnist/archive/mnist_test.csv"
	...
	XTtrain := mat.NewDense(10000, 784, features)
	yTrain := mat.NewDense(10000, 1, labels)

  fmt.Println("Successfully read mnist testing dataset")
